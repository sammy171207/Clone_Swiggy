...
import spicestory.spicestory.request.LoginRequest;
import spicestory.spicestory.response.AuthResponse;
import spicestory.spicestory.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    private Authentication authenticate(String username, String password) {
        ...
        if(username==null){
            throw new BadCredentialsException("Invalid User Named");
        }
